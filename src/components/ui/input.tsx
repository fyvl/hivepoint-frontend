        ...
        return (
            <input
                ...
                className={cn(
                    ...
                    "focus-visible:border-primary/50 focus-visible:bg-background focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/20 dark:focus-visible:border-primary/55 dark:focus-visible:bg-card dark:focus-visible:ring-primary/[0.18] dark:focus-visible:shadow-[0_0_0_1px_hsl(var(--primary)/0.14),0_14px_34px_-24px_hsl(var(--shadow-color)/0.88),inset_0_1px_0_hsl(var(--foreground)/0.06)]",
